...
use Coyote\SiteBundle\Entity\Item;
use Coyote\SiteBundle\Form\ItemType;
...
class ItemController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CoyoteSiteBundle:Item')->findAll();

        return $this->render('CoyoteSiteBundle:Item:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('CoyoteSiteBundle:Item:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CoyoteSiteBundle:Item')->find($id);
        ...
        return $this->render('CoyoteSiteBundle:Item:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('CoyoteSiteBundle:Item:edit.html.twig', array(
            'entity'      => $entity,
